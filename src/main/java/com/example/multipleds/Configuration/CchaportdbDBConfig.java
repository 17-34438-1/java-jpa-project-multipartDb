...
@EnableJpaRepositories(entityManagerFactoryRef = "cchaportdbEntityManagerFactory",
        basePackages = {"com.example.multipleds.Repository.cchaportdb"}, transactionManagerRef = "cchaportdbTransactionManager")
public class CchaportdbDBConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(EntityManagerFactoryBuilder builder,
        ...
        return builder.dataSource(dataSource).properties(properties)
                .packages("com.example.multipleds.Model.cchaportdb").persistenceUnit("Igm").build();
