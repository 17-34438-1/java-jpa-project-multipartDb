...
@EnableJpaRepositories(entityManagerFactoryRef = "sparcsn4EntityManagerFactory",
        basePackages = {"com.example.multipleds.Repository.sparcsn4"},transactionManagerRef = "transactionManager")
public class Sparcsn4DBConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(EntityManagerFactoryBuilder builder,
        ...
        return builder.dataSource(dataSource).properties(properties)
                .packages("com.example.multipleds.Model.sparcsn4").persistenceUnit("Navis").build();
